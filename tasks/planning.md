...
6. **Multi-integrin first-principles extension** — extend to 6WOV (α5β1 bent cryo-EM). Skipped earlier because mdtraj's CIF support flagged the asymmetric unit aggregation as 4 copies; needs clean ectodomain extraction script.
...
## Audit 2026-05-05 status (v17, end of day)
- 20 objectives shipped today (obj-038→obj-057), 7 docs, 2 starter scripts, 17 deepening passes
...
- Composite figure at `figures/audit-2026-05-05.png` (18 deliverable tiles, v17)
